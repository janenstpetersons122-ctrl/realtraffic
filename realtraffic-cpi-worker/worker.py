"""RealTraffic CPI Worker — entry point.
...
from realtraffic_cpi_worker.config import load_config  # noqa: E402
from realtraffic_cpi_worker.orchestrator import Orchestrator, run_doctor  # noqa: E402

VERSION = "1.0.0"


def main() -> int:
    p = argparse.ArgumentParser(prog="realtraffic-cpi-worker")
    ...
    if args.version:
        print(f"realtraffic-cpi-worker {VERSION}")
        return 0
