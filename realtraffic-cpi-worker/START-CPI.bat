@echo off
title RealTraffic CPI Worker
setlocal enabledelayedexpansion
cd /d "%~dp0"

echo.
echo ================================================================
echo    REALTRAFFIC CPI WORKER - ONE CLICK LAUNCHER
echo ================================================================
echo.
...
findstr /C:"PASTE_YOUR_REALTRAFFIC_JWT_HERE" "%~dp0config.yaml" >nul 2>&1
if errorlevel 1 goto config_ok
echo.
echo  [X] config.yaml mein TOKEN paste nahi hua hai!
echo.
echo  TOKEN KAHAN SE LE:
echo    1. https://realtraffic.online par login karein
echo    2. F12 dabayein - DevTools khulega
echo    3. Application tab - Local Storage - https://realtraffic.online
echo    4. "token" key dhundhein - lambi value copy karein
echo    5. Notepad mein PASTE_YOUR_REALTRAFFIC_JWT_HERE replace karein
...
echo    1. https://realtraffic.online kholein, login karein
