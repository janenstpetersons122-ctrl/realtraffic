================================================================
   REALTRAFFIC CPI WORKER - PEHLE PARHEIN (Roman Urdu Guide)
================================================================
...
STEP 3:  Token paste karne ka tareeqa:
         a. Browser mein https://realtraffic.online kholein
         b. Login karein:  admin@realtraffic.local / admin123
         c. F12 dabayein (DevTools khulega)
         d. "Application" tab > Local Storage > https://realtraffic.online
         e. "token" naam ki entry dhundhein - uski lambi value copy karein
         f. Notepad mein "PASTE_YOUR_REALTRAFFIC_JWT_HERE" replace karein
            (token paste karein, baki kuch na chedhein)
         g. Ctrl+S (save) > close

STEP 4:  Web UI mein job banayein aur start karein:
         a. https://realtraffic.online > CPI module
         b. New Job:
