"""
CPI (Cost-Per-Install) Module for RealTraffic
==========================================
...
Purpose:
  ...
  is performed by a separate `realtraffic-cpi-worker` process which polls jobs
...
class CPIJobIn(BaseModel):
    ...
    # Pull from Uploaded Things (RealTraffic's existing resource pool)
