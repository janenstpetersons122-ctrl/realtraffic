      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="text-center mb-8">
          {branding.logo_url ? (
            ...
            <h1 className="text-4xl font-bold mb-2" style={{ color: 'var(--brand-text)' }} data-testid="app-title">{branding.app_name || "RealTraffic"}</h1>
          )}
        ...
        {/* Footer */}
        <p className="text-center text-xs text-[#52525B] mt-6">{branding.footer_text || "© 2026 RealTraffic. All rights reserved."}</p>
      </div>
    </div>
  );
}
