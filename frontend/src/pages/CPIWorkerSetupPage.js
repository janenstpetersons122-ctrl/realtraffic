    ...
    <div className="space-y-6 max-w-4xl" data-testid="cpi-worker-setup-page">
      ...
      <div className="border rounded-lg p-5 bg-amber-500/5 border-amber-500/30 space-y-2">
        ...
        <ul className="text-sm text-muted-foreground list-disc ml-6 space-y-1">
          ...
          <li>RealTraffic already deployed (this site you are viewing)</li>
      ...
      <Step n={1} title="Pull the latest worker code on your home PC">
        ...
        <Code>{`cd C:\\realtraffic
.\\REALTRAFFIC-UPDATE.bat`}</Code>
...
.\\deployment\\cpi\\REALTRAFFIC-CPI-SETUP.ps1`}</Code>
      ...
      <Step n={3} title="Copy your JWT and paste into config.yaml">
        <p>Click the button below to copy your authentication token, then open <code className="bg-muted px-1 py-0.5 rounded text-xs">C:\realtraffic\realtraffic-cpi-worker\config.yaml</code> and paste it under <code className="bg-muted px-1 py-0.5 rounded text-xs">api.token</code>.</p>
  ...
  poll_interval_seconds: 5`}</Code>
      ...
      <Step n={5} title="Verify everything works (Doctor)">
        <Code>{`.\\deployment\\cpi\\REALTRAFFIC-CPI-DOCTOR.ps1`}</Code>
      ...
      <Step n={6} title="Start the worker">
        ...
        <Code>{`.\\deployment\\cpi\\REALTRAFFIC-CPI-WORKER-START.bat`}</Code>
      ...
      <div className="border rounded-lg p-5 space-y-3 bg-blue-500/5 border-blue-500/30">
        ...
        <ul className="text-sm space-y-1">
          ...
          <li>• <code className="bg-muted px-1 py-0.5 rounded text-xs">realtraffic-cpi-worker/README.md</code> — worker architecture</li>
        </ul>
      </div>
    </div>
  );
