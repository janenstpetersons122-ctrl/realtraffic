# Install RealTraffic CPI Worker as Windows Service (auto-start on boot) - ASCII safe
...
$WORKER      = Join-Path $ROOT "realtraffic-cpi-worker"
...
nssm set $SERVICE Description "RealTraffic CPI Install Worker"
