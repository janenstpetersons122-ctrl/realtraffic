...
title RealTraffic - One Click Upgrade
color 0A

REM ====================================================================
REM   RealTraffic ONE-CLICK UPGRADE
REM   ─────────────────────────
...
set "OLD_PATH=F:\online\real flow\real flow amna\realtraffic-amna-main\realtraffic-amna-main"
set "NEW_PATH=F:\online\real flow\lenovo real flow\lenovo-realtraffic-main\lenovo-realtraffic-main"
set "BACKUP_ROOT=F:\online\real flow\realtraffic-backups"

cls
echo.
echo  ============================================================
echo    RealTraffic - ONE CLICK UPGRADE
echo  ============================================================
echo.
...
echo.
echo    Ab kya karein:
echo      1. Apna RealTraffic URL browser mein kholein
echo      2. Login karein (admin@realtraffic.local / admin123)
echo      3. Sidebar mein "CPI Module" dropdown dikhega
echo      4. Phir CPI Worker setup karein (Android phone connect karne ke liye)
echo.
echo    Logs check karne ke liye: REALTRAFFIC-LOGS.bat
echo    Containers band karne ke liye: REALTRAFFIC-STOP.bat
echo.
echo  ============================================================
echo.
pause
