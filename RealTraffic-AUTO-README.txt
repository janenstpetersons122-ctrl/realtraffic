================================================================
   REALTRAFFIC AUTO - SIRF EK FILE, BAS
   + GitHub Auto-Update (no more manual download/extract)
================================================================

YEHI EK FILE:  RealTraffic-AUTO.bat
...
1. Right-click on RealTraffic-AUTO.bat
2. "Run as administrator" select karein
3. Pehli baar GitHub repo URL paste karein:
      Example: https://github.com/yourname/realtraffic.git
...
* Windows Task Scheduler "RealTrafficAutoUpdate" task banta hai
...
CMD/PowerShell mein:
    "F:\online\real flow\realtraffic\RealTraffic-AUTO.bat" _UNINSTALL_

Yeh sirf scheduled task hatayega. Containers chalte rahenge.

Dobara enable karna ho:
    RealTraffic-AUTO.bat ko dobara double-click
...
Logs file dekhe:
   F:\online\real flow\realtraffic\deploy.log
   F:\online\real flow\realtraffic\watcher.log

Backup folder mein purani DB safe hai:
   F:\online\real flow\realtraffic-backups\auto-YYYYMMDD-HHMMSS\
